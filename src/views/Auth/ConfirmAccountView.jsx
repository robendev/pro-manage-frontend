...
const ConfirmAccountView = () => {
    ...
    return (
        <div className="flex-1 flex flex-col justify-center px-4">
            <h1 className="text-center font-bold mb-2">Confirmar Cuenta</h1>
            <p>Para confirmar tu cuenta, por favor ingresa el token de confirmación que te hemos enviado por correo electrónico.</p>
            <p>Si no has recibido el correo, asegúrate de revisar tu carpeta de spam o solicita un nuevo token.</p>
