...
const ProjectCard = ({ project, userData }) => {
    ...
    return (
        <div className="bg-gray-100 rounded-sm shadow w-full max-w-80 p-2 space-y-4">
            <div className="space-y-1">
                ...
                <Link to={`/projects/${project._id}`}>
                    <h2 className="relative text-center font-bold line-clamp-1 border-paint mb-2">{project.projectName}</h2>
                </Link>
